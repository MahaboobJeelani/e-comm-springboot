...
import '../Styles/UseLocation.css'

const UseLocation = (citylist) => {
  ...
  let UserData = { house_number, buildingName, landmark, city, state, country, address_type, pincode }

  const addData = () => {
    // axios.post(`http://localhost:8080/address/${user.id}`, UserData)
    axios.post(`http://localhost:8080/address/`, UserData)
  ...
  return (
    <div className='uselocation'>
      <div className='addressdata'>
        <div className='headingaddres'>
          <h1>Add Address</h1> <hr />
        </div>
        <form className='locationform'>

          <label htmlFor="">Address Type :</label>
          <select value={address_type} onChange={(e) => { setaddress_type(e.target.value) }}>
            <option>Home</option>
          ...
          <input type="text" value={house_number} onChange={(e) => sethouse_number(e.target.value)} />
